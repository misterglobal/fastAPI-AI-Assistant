...
@router.get("/env-vars", response_model=Dict[str, bool])
async def check_env_vars(current_user: Dict = Depends(get_current_user)):
    """
    ...
    logger.info(f"Checking environment variables for user {current_user.get('sub')}")
    ...
    env_vars = {
        ...
        "POSTGRES_SERVER": bool(os.environ.get("POSTGRES_SERVER")),
        "POSTGRES_USER": bool(os.environ.get("POSTGRES_USER")),
        "POSTGRES_PASSWORD": bool(os.environ.get("POSTGRES_PASSWORD")),
        "POSTGRES_DB": bool(os.environ.get("POSTGRES_DB")),
        ...
        "OPENAI_EMBEDDING_MODEL": bool(os.environ.get("OPENAI_EMBEDDING_MODEL")),
        "ELEVENLABS_API_KEY": bool(os.environ.get("ELEVENLABS_API_KEY")),
        "ELEVENLABS_DEFAULT_VOICE": bool(os.environ.get("ELEVENLABS_DEFAULT_VOICE")),
        ...
        "BASE_URL": bool(os.environ.get("BASE_URL"))
    }
